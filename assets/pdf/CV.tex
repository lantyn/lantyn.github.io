...
My research focuses on the theory of topological phases of matter: intrinsic topological order, symmetry protected topological phases (including topological insulators as a special case), symmetry enriched topological phases, higher dimensional generalization of symmetry and topological phases, and their mathematical foundation: tensor category, higher category, higher algebra, group cohomology, algebraic topology, etc.
I obtained the first complete classification of 3+1D topological orders and the techniques used can also greatly simplify the study of topological phases in even higher dimensions.
Recently, topological defects have been recognized as generalized symmetries, which is a conceptual revolution. I am interested in the underlying mechanism and mathematical framework for generalized symmetry, in order to better understand and organize phases and phase transitions.


\section*{Grants}
% Direct Grant No. 4053501, The Chinese University of Hong Kong\\
% Direct Grant No. 4053667, The Chinese University of Hong Kong\\
PI, Early Career Scheme (ECS) No.~24304722, Hong Kong Research Grants Council\\
PI, Guangdong Provincial Quantum Science Strategic Initiative No.~GDZX2501013\\
Co-PI, Collaborative Research Fund (CRF) No.~C7015-24GF, Hong Kong Research Grants Council
	

\section*{Teaching}
\begin{tabular}{ll}
  2021-25 Fall & PHYS5410 Advanced Quantum Mechanics\\
  2024-26 Spring& PHYS1111 University Physics I %, Introduction to Mechanics, Fluids and Waves
\end{tabular}



\section*{Referee}
Physical Review Series (PRX, PRX Quantum, PRL, PRResearch, PRB)\\
Communications in Mathematical Physics, Journal of High Energy Physics, SciPost Physics, Quantum \dots
...
\item A ``Periodic Table'' of Topological Orders
  ...
  \begin{itemize}\tiny
    \item SIAM Annual Meeting (AN16), Boston, Massachusetts, USA, July 2016 (invited but was not able to attend due to visa delay)
...
\item Higher Dimensional Topological Order, Higher Category and A Classification
  ...
  \begin{itemize}\tiny
     \item Center of Mathematical Sciencies and Applications, Harvard University, April 2020
  \end{itemize}
  ...
  \begin{itemize}\tiny
    ...
    \item SUSTech Summer School on Generalized Symmetry and Quantum Criticality, October 2025
    \item MIST Conference, CUHK, Feburary 2026
  \end{itemize}
  \item Pro-Tensor Network~\supercite{YBWL2605.06661}
  \begin{itemize}\tiny
    \item Advanced Numerical Methods for Highly Entangled Quantum Matter, CY Cergy Paris Universite, France, May 2026
    \item Frontier Workshop on Topological States and Strongly Correlated Quantum Matter, Tsung-Dao Lee Center of Sciences and Arts, Dali, July 2026
  \end{itemize}
